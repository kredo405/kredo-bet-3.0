...
function publishMatches(arrMatches) {
  ...
  const mathesItems = matchesList.querySelectorAll('div');
  mathesItems.forEach((el) => {
    el.remove();
  });

  arrMatches.forEach((el) => {
    let div = document.createElement('div');
    div.classList.add('matches__item');
    div.innerHTML = `
    <p class="matches__colapse-wrapper matches__colapse-wrapper${el.fixture.id}">
              <button
                class="btn btn-primary matches__collapse-btn  matches__collapse-btn${el.fixture.id}"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#collapseExample${el.fixture.id}"
                aria-expanded="false"
                aria-controls="collapseExample${el.fixture.id}"
              >
                <img
                ...
                />
                <p class="matches__team-name">${el.teams.home.name}</p>
                <svg
                ...
                <p class="matches__team-name">${el.teams.away.name}</p>
                <img
